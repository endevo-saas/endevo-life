...
export default function EmployeeSettingsPage() {
  ...
  const strengthColor = ['', 'bg-red-500', 'bg-orange-500', 'bg-yellow-500', 'bg-green-500', 'bg-purple-400']
      ...
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="glass p-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div><p className="text-xs text-slate-500 mb-1">Role</p><p className="text-sm text-purple-300 font-medium">{role.replace('_',' ')}</p></div>
          </div>
        </div>
